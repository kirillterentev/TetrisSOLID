...
public class ModeTwo : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _tetrisGrid = new TetrisGridV2(12, 20, _tetrisGraphic, _userParameter);
        _figureMovement = new FigureMovementV2(_tetrisGrid);

        _tetrisGraphic.DrawGrid(12, 20, GridCell);
